...
refevent:string=null;
  ...
  constructor(public navCtrl: NavController, private camera : Camera,
    ...
    private domSanitizer: DomSanitizer, private transfer: Transfer, private file: File, private filePath: FilePath, public actionSheetCtrl: ActionSheetController, public toastCtrl: ToastController, public platform: Platform, public loadingCtrl: LoadingController, public http: Http,public storage: Storage) {
...
var link = 'http://93.115.97.208/bwus/post/create.php';
 //var url = 'http://93.115.97.208/alvybatrest/uploads/'+this.lastImage;
